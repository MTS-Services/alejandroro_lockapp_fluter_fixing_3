...
const io = new Server(httpServer, { cors: {
        origin: 'https://affinitysocialclub.com',
        methods: ['GET', 'POST'],
        credentials: true,
    } 
});
...
const imageurl = "https://affinitysocialclub.com/public/";
...
io.on("connection", (socket) => {
  ...
  // Handle disconnect event
    ...
    socket.on("send_media", (data, callback) => {
        ...
        var fileurl = imageurl+'/uploads/chatmedia/'+fileName;
    ...
    socket.on("send_call", (data, callback) => {
        ...
        var fileurl = imageurl+'uploads/profile/';
